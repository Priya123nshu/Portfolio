...
//           className="mb-6 justify-center text-2xl font-light text-muted-foreground md:text-3xl"
//           delay={0.4}
//         />
...
//         >
//           Crafting neural architectures, deploying machine learning models at scale,
//           and transforming data into actionable intelligence. Specialized in deep learning,
...
//             <span className="text-foreground"> neural_network</span>
//             <motion.span
//               animate={{ opacity: [1, 0] }}
